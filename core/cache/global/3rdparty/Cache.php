...
*/
    ...
    */
    class Phpguru_OutputCache extends Phpguru_Cache
    {
        /**
    ...
    */
    class Phpguru_DataCache extends Phpguru_Cache
    {
        ...
        */
        public static function GetData($group, $id)
        {
            if (self::isCached($group, $id)) {
        ...
        */
        public static function PutData($group, $id, $ttl, $data)
        {
