...
class Footer {
    ...
    function Footer() {
	$this->left = new JPGRAPH_Text();
	$this->left->ParagraphAlign('left');
	$this->center = new JPGRAPH_Text();
	$this->center->ParagraphAlign('center');
	$this->right = new JPGRAPH_Text();
...
// PUBLIC METHODS	
	...
	if( ($cl instanceof JPGRAPH_Text) || ($cl instanceof PlotLine) || 
...
class GraphTabTitle extends JPGRAPH_Text{
...
//===================================================
class SuperScriptText extends JPGRAPH_Text {
    private $iSuper="";
	...
	parent::JPGRAPH_Text($aTxt,$aXAbsPos,$aYAbsPos);
	$this->iSuper = $aSuper;
    }
